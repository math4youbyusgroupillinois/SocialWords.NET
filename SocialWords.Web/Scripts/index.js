...
document.getElementById("question").addEventListener("click", function(){
    ...
    query_type = "Question";
    document.querySelector("fb_share").setAttribute("data-href", "http://pearson.lexicum.net/" + query_type + "/index/?word=" + @ViewBag.Word);
});
...
document.getElementById("definition").addEventListener("click", function(){
    ...
    document.querySelector("#fb_share").attr("data-href", "http://pearson.lexicum.net/" + query_type + "/index/?word=" + @ViewBag.Word);
//    $("#fb_share").attr("data-href", "http://pearson.lexicum.net/" + query_type + "/index/?word=" + @ViewBag.Word);
});